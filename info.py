...
API_ID = int(environ.get('API_ID', '24324252'))
API_HASH = environ.get('API_HASH', '7f5a95a95508059acc07a7c3e3697081')
BOT_TOKEN = environ.get('BOT_TOKEN', '7791060079:AAGuAG39lXUQJl91EMlKhhFUwVbRP4XODp4')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '24324252').split()]
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002381851296').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Innovex:INNOVEX@12@innovex.nu57s.mongodb.net/?retryWrites=true&w=majority&appName=Innovex")
DATABASE_NAME = environ.get('DATABASE_NAME', "INNOVEX ")
