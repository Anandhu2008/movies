...
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1002381851296').split()]
USERNAME = environ.get('USERNAME', "https:https://t.me/anandhuyoooo") # ADMIN USERNAME
